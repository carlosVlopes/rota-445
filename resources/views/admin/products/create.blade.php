        ...
        <div class="grid grid-cols-2 gap-5">
            ...
            <div class="col-span-2">
                ...
                <textarea name="description" rows="3"
                          class="w-full px-3 py-2 rounded-xl border {{ $errors->has('description') ? 'border-red-300' : 'border-gray-200' }} text-sm focus:outline-none focus:border-orange-400 resize-none">{{ old('description') }}</textarea>
            ...
            <div class="flex items-end pb-0.5">
                <label class="flex items-center gap-2.5 cursor-pointer">
                    <div x-data="{ checked: {{ old('active', '1') ? 'true' : 'false' }} }"
